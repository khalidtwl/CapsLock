...
struct
  ...
  exception ImproperDimensions3
  exception ImproperDimensions4
  exception ImproperDimensions5
  exception ImproperDimensions6
  exception ImproperDimensions7
  exception ImproperDimensions8
  exception ImproperDimensions9
  exception ImproperDimensions10
  ...
  let empty (rows: int) (columns: int) : matrix = 
    if rows > 0 && columns > 0 then
      ...
      with Invalid_argument "index out of bounds" ->
        raise ImproperDimensions1
    else (* dimension is negative or 0 *)
      raise ImproperDimensions2
  ...
  let dot (v1: elt array) (v2: elt array) : elt =
    ...
    else raise ImproperDimensions5
